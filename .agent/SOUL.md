...
2. **Session branch only:** all work on `arena/01a0a077-maqc-7`. Never switch, create, or push other branches.
...
5. **Ask when ambiguous** (missing files, unclear intent) — but keep momentum on everything else.
